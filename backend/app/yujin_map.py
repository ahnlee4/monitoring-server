...
SYSTEM_ENTRIES = [
    ...
    MapEntry("0016", 2, 2, False, "80", "Unload Pressure", "system"),
    MapEntry("0018", 2, 2, False, "70", "Load Pressure", "system"),
    MapEntry("001A", 2, 2, False, "2", "Comp Pressure Level", "system"),
    MapEntry("001C", 2, 2, False, "50", "Low Alarm Pressure", "system"),
    MapEntry("001E", 2, 2, False, "0", "Dio Connect", "system"),
    MapEntry("0020", 2, 2, False, "0", "Ma420 Connect", "system"),
    MapEntry("0022", 2, 2, False, "1", "Total Individual Mode", "system"),
    MapEntry("0024", 2, 2, False, "0", "Comp Sort", "system"),
    MapEntry("0026", 2, 2, False, "2", "Somp Start Qty", "system"),
    MapEntry("0028", 2, 2, False, "1", "Run Sequence1", "system"),
    MapEntry("002A", 2, 2, False, "2", "Run Sequence2", "system"),
    MapEntry("002C", 2, 2, False, "3", "Run Sequence3", "system"),
    MapEntry("002E", 2, 2, False, "4", "Run Sequence4", "system"),
    MapEntry("0030", 2, 2, False, "5", "Run Sequence5", "system"),
    MapEntry("0032", 2, 2, False, "6", "Run Sequence6", "system"),
    MapEntry("0034", 2, 2, False, "7", "Run Sequence7", "system"),
    MapEntry("0036", 2, 2, False, "8", "Run Sequence8", "system"),
    MapEntry("0038", 2, 2, False, "0", "Run Sequence9", "system"),
    MapEntry("003A", 2, 2, False, "5", "Start Comp", "system"),
    MapEntry("003C", 2, 2, False, "5", "Run Delay Time", "system"),
    MapEntry("003E", 2, 2, False, "5", "Main Press Choice Part", "system"),
    MapEntry("0040", 2, 2, False, "1", "Autostop Time_min", "system"),
    MapEntry("0042", 2, 2, False, "2", "Autostop Time_hour", "system"),
    ...
    MapEntry("004A", 2, 2, False, "4351", "Option Device", "system"),
    MapEntry("004C", 2, 2, False, "4103", "Use Device", "system"),
