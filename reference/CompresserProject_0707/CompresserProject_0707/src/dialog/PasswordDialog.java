...
public class PasswordDialog extends JDialog{
	...
	JPasswordField password_val_label;
	...
	public PasswordDialog() {
		...
		main_panel.add(password_label = new MyLabel("비밀번호 입력",0, MyFont.Font_24, Color.black));
		main_panel.add(password_val_label = new JPasswordField(""));
